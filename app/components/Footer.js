            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
                    ...
                    <ul class="text-lg text-center sm:flex items-cente justify-center gap-14 lg:gap-10 xl:gap-14 transition-all duration-500">
                        ...
                        <li class="sm:my-0 my-2"><a href="javascript:;" class="text-gray-400 hover:text-gray-50/75 transition">Blog</a></li>
                        <li ><a href="javascript:;" class="text-gray-400 hover:text-gray-50/75 transition">Support</a></li>
                    </ul>
                    <div class="flex  space-x-4 sm:justify-center  ">
                        ...
                        <a href="javascript:;" class="w-9 h-9 rounded-full bg-gray-800 flex justify-center items-center hover:bg-indigo-600">
                            <svg class="w-[1.25rem] h-[1.125rem] text-gray-400" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="javascript:;" class="w-9 h-9 rounded-full bg-gray-800 flex justify-center items-center hover:bg-indigo-600">
                            <svg class="w-[1rem] h-[1rem] text-gray-400" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="javascript:;" class="w-9 h-9 rounded-full bg-gray-800 flex justify-center items-center hover:bg-indigo-600">
                            <svg class="w-[1.25rem] h-[0.875rem] text-gray-400" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
