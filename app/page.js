                              ...
                              <li className="w-full">
                                <div className="flex items-center space-x-4">
                                  <div className="flex-shrink-0">
                                    <Image priority width={32} height={32} className="w-8 h-8 rounded-full" src={item.profilePhoto ? item.profilePhoto : 'https://res.cloudinary.com/dlwudcsu1/image/upload/v1723743051/Picsart_24-08-15_23-00-10-662_bix7iy.png'} alt="Neil image" />
                                  </div>
